...
app.use('/login', require('./api/controllers/login.controller'));
app.use('/register', require('./api/controllers/register.controller'));
app.use('/app', require('./api/controllers/app.controller'));
app.use('/api/users', require('./api/controllers/api/users.controller'));
